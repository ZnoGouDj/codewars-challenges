...
function setAlarm(employed: B, vacation: B): B {
  return employed !== vacation && employed === true;
}

//another mine

const setAlarm1 = (e: B, v: B): B => e !== v && e === true;

//top

const setAlarm2 = (employed: B, vacation: B): B => employed && !vacation;

//top2

function setAlarm3(employed: B, vacation: B): B {
