...
// In that case, we return, "Well done!
// You have advanced to the qualifying stage. Win 2 out of your next 3 games to rank up.".
...
// Test.assertEquals(playerRankUp(64), false)
// Test.assertEquals(playerRankUp(101), "Well done! You have advanced to the qualifying stage. Win 2 out of your next 3 games to rank up.")

function playerRankUp(points: number): boolean | string {
  return points >= 100
