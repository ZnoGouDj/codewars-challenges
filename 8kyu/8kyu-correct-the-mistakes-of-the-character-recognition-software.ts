...
let correct1 = (s: S): S => s.replace(/0/g, 'O').replace(/1/g, 'I').replace(/5/g, 'S');
...
const correct2 = (string: S): S => string.replace(/[501]/g, character => corrections[character]);
