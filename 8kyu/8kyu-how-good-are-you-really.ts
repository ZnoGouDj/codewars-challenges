...
function betterThanAverage(classPoints: N[], yourPoints: N): boolean {
  let sum = 0;
  let avg: number;
...
function betterThanAverage1(classPoints: N[], yourPoints: N): boolean {
  return yourPoints > classPoints.reduce((a, b) => a + b, 0) / classPoints.length;
}

//another

const betterThanAverage2 = (c: N[], y: N): boolean => y > c.reduce((a, b) => a + b) / c.length;
