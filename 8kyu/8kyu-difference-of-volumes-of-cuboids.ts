...
function findDifference(a: N[], b: N[]): N {
...
function find_difference1(a: N[], b: N[]): N {
  return Math.abs(
    a.reduce((previous, current) => previous * current) - b.reduce((previous, current) => previous * current)
  );
}

//lol

function find_difference2(a: N[], b: N[]): N {
  return Math.abs(a[0] * a[1] * a[2] - b[0] * b[1] * b[2]);
}
//another
function find_difference3([a, b, c], [d, e, f]) {
