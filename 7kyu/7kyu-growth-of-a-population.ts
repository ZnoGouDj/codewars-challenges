...
body of your function: if the parameter percent is 2 you have to convert it to 0.02.
...
function nbYear(p0: N, percent: N, aug: N, p: N): N {
  let years = 0;
  let growth = p0;
  while (growth < p) {
...
function nbYear1(p0: N, percent: N, aug: N, p: N): N {
...
function nbYear2(p0: N, percent: N, aug: N, p: N): N {
  let y = 0;
  while (p0 < p) {
